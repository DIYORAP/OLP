    ...
    return (
        <div>
            ...
            <div className='flex flex-wrap gap-2 m-2'>
                {
                    tags.map((tag, index) => (
                        <div key={index} className='m-1 flex items-center rounded-full bg-black px-2 py-1 text-sm text-white'>
            ...
            />
            {
                errors[name] && <span className='text-xs text-red-500'>Tags are required</span>
