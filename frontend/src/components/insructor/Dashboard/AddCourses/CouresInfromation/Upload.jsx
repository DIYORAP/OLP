                ...
                image ? (
                    ...
                    <div className="flex flex-col space-y-2">
                        <label className="text-sm text-richblack-5" htmlFor={label}>
                            ...
                            <div className="bg-richblack-700 flex min-h-[250px] cursor-pointer items-center justify-center rounded-md border-2 border-dotted border-black">
                                <div
                                ...
                                >
                                    ...
                                    <p className="mt-2 max-w-[200px] text-center text-sm text-richblack-200">
                                        ...
                                        <span className="font-semibold text-black">Browse</span> a file
                                    </p>
