...
const SubsectionModal = ({
    ...
    return (
        <div className='fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-white bg-opacity-15 backdrop-blur-sm'>
            <div className='my-10 w-11/12 max-w-[700px] rounded-lg border border-black bg-white'>
                <div className='flex items-center justify-between rounded-t-lg  p-5'>
                    <p className='text-xl font-bold text-black'>{view && "Viewing"} {add && "Adding"} {edit && "Editing"} Lecture</p>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 px-8 py-10">
                    ...
                    <div className='flex flex-col space-y-2'>
                        <label className='text-sm text-black' htmlFor='lecture'>Lecture Title</label>
                        <input disabled={view}
                            id='lecture'
                        ...
                        />
                        {errors.lectureTitle && (<span className='ml-2 text-xs tracking-wide text-red-700'>
                            Lecture Title is required
                        </span>)}
                    </div>
                    <div className='flex flex-col space-y-2'>
                        <label className='text-sm text-black'>Lecture Description</label>
                        ...
                        />
                        {
                            errors.lectureDesc && (<span className='ml-2 text-xs tracking-wide text-red-700'>
